/**
 * Copyright (c) 2025–2026 PK Limited
 * 
 * All rights reserved.
 * 
 * This software, including source code, data processing scripts, 
 * and any associated assets, is the exclusive property of PK Limited 
 * and is protected under New Zealand copyright law and international 
 * copyright treaties.
 * 
 * Unauthorized reproduction, distribution, modification, reverse engineering, 
 * or commercial exploitation is strictly prohibited without prior written 
 * consent from PK Limited.
 * 
 * For licensing, permissions, or inquiries: contact@pklimited.nz (or your preferred contact)
 */
